  ...
  return (
    <div className="av-page content-inner">
      <div className="av-header">
        <h1>Все вакансии</h1>
        {!isLoading && (
          <span className="av-header-count">{vacancies.length} вакансий</span>
        )}
      </div>
      ...
      {!isLoading && vacancies.length === 0 && (
        <div className="av-empty">Нет активных вакансий</div>
      )}
      ...
      {!isLoading && vacancies.length > 0 && (
        <div className="av-grid">
          {vacancies.map((v) => {
            ...
            const descText = v.description ? stripHtml(v.description) : '';
            ...
            return (
              ...
              >
                ...
                {descText && (
                  <div className="av-card-desc">{descText}</div>
                )}
