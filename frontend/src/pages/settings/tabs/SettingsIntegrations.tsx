          ...
          <div className="integ-section">
            {b24Loading ? (
              ...
              <div>
                ...
                <div className="info-banner small">
                  <Icon name="sparkle" size={14} />
                  <div>Импорт сотрудников в Глафиру и отчёт «Текучка» — следующий этап (вебхук уже читает данные с портала). Для записи на интервью Глафира считает свободные слоты <strong>по календарям сотрудников из Битрикс24</strong> — вебхуку нужны права <strong>user + calendar</strong>, а участники вакансий должны быть привязаны к пользователям Б24 (Настройки→Права доступа).</div>
                </div>
