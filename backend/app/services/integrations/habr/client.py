...
Эндпоинты (проверены живым пробингом на токене работодателя 2026-08-20):
  BASE = https://career.habr.com/api/v1/integrations  (конфигурируемый HABR_API_BASE)
  ⚠️ Путь С префиксом /api/ — без него всё летит в 404 (реальный инцидент).
